          ...
          >
            ...
            <div className="flex justify-center gap-4 pt-2">
              ...
              {onClose && (
                <button
                  onClick={onClose}
                  className="px-6 py-2 rounded-xl bg-gradient-to-br from-[#4e9377] via-[#5ea489] to-[#d4a342] text-xs font-bold text-white shadow-md shadow-[#4e9377]/20 border border-white/10 hover:brightness-105 active:scale-[0.98] transition-all cursor-pointer"
                >
